...
//   updateExpense,
//   deleteExpense,
// } from "../src/services/expenseService"; // ✅ import services
...
//       setExpenses(data);
//     } catch {
//       message.error("Failed to fetch expenses", "error");
//     }
//   };
...
//       message.error("Please fill in required fields", "error");
//       return;
//     }
...
//           amount: parseFloat(form.amount),
//         });
//         message.success("Expense updated successfully!", "success");
//       } else {
//         await addExpense({
//           ...form,
//           amount: parseFloat(form.amount),
//         });
//         message.success("Expense added successfully!", "success");
//       }
//       resetForm();
//       fetchExpenses();
//     } catch {
//       message.error("Operation failed. Please try again.", "error");
//     }
//   };
...
//       message.success("Expense deleted successfully!", "success");
//       fetchExpenses();
//       setShowDeleteModal(false);
//       setDeleteId(null);
//     } catch {
//       message.error("Failed to delete expense", "error");
//     }
//   };
